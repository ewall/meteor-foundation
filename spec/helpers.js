...
beforeEach(function() {
  ...
  $.ajax({ url: '/base/css/normalize.css', cache: false, async: false, success: function(data) {
    $('#foundation-style').html(data);
  }});

  $.ajax({ url: '/base/css/foundation.min.css', cache: false, async: false, success: function(data) {
